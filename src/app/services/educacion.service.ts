...
export class EducacionService {
  ...
  private urlEdu:string = "https://anm-backend-repo-anmlargus.koyeb.app/api/edus"; // "https://morning-spire-26047.herokuapp.com/api/edus" /* 'http://localhost:3000/edus';  'http://localhost:8081/api/edus' */ ;
