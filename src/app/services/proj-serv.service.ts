...
export class ProjServService {
  ...
  urlProj:string = "https://anm-backend-repo-anmlargus.koyeb.app/api/proyectos"; //"https://morning-spire-26047.herokuapp.com/api/proyectos" /* 'http://localhost:3000/projs';  'http://localhost:8081/api/proyectos' */ ;
